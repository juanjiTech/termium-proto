...
func (c *userServiceClient) CheckEmailVerifyCode(ctx context.Context, in *CheckEmailVerifyCodeRequest, opts ...grpc.CallOption) (*CheckEmailVerifyCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_CheckEmailVerifyCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserPublicKey(ctx context.Context, in *GetUserPublicKeyRequest, opts ...grpc.CallOption) (*GetUserPublicKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetUserPublicKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) CheckEmailVerifyCode(context.Context, *CheckEmailVerifyCodeRequest) (*CheckEmailVerifyCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckEmailVerifyCode not implemented")
}
func (UnimplementedUserServiceServer) GetUserPublicKey(context.Context, *GetUserPublicKeyRequest) (*GetUserPublicKeyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserPublicKey not implemented")
}
